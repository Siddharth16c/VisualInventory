...
OpenCode VSCode Extension Preview
...
Workspace opencode.json (if present in project root)
...
Set environment variable: export OVSX_PAT=your_open_vsx_token
Login to VS Code Marketplace: npx vsce login <publisher>
Run: npm run publish
