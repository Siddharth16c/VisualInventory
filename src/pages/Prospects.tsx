        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
            <div className="glass rounded-2xl p-6 w-full max-w-md animate-slide-up">
                <div className="flex justify-between mb-5">
                    <h3 className="text-lg font-semibold text-surface-500">{prospect ? 'Edit Prospect' : 'Add Prospect'}</h3>
                    ...
                    filtered.map((p) => (
                        <div key={p.id} className="glass rounded-xl p-4 card-hover">
                            <div className="flex justify-between items-start mb-3">
                                <h3 className="font-semibold text-surface-900">{p.prospectname}</h3>
